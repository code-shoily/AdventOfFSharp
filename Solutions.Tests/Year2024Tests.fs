...
module TestYear2024Solutions =
    ...
    let ``Solves Day 10`` () =
        let day = 10
        let expected = BothInt(617, 1477)

        let actual = Year2024.Day10.solve (getInput day)
    ...
    let ``Solves Day 11`` () =
        let day = 11
        let expected = BothLong(172484L, 205913561055242L)

        let actual = Year2024.Day11.solve (getInput day)
    ...
    let ``Solves Day 25`` () =
        let day = 25
        let expected = IntString(3146, "🎉")

        let actual = Year2024.Day25.solve (getInput day)
